...
function Dashboard() {
  const itemList = [{users:"100", revenue: "40k", packages:"200", labs:"40"}];
  const data = {
    labels: [
      "9:00AM",
      "12:00AM",
  ...
  const piedata={
    labels: ["30%", "20%", "20%", "10%", "20%"],
    series: [30, 20, 20,10,20],
  }
  const piechartdata={
                ...
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      ...
                      <Card.Title as="h4">{itemList.users}</Card.Title>))} 
                    </div>
                  </Col>
                </Row>
              </Card.Body>
                ...
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      ...
                      {itemList.map(itemList => (
                      <Card.Title as="h4">{itemList.revenue}</Card.Title>))}
                    </div>
                  </Col>
                </Row>
              </Card.Body>
            ...
            <Card className="card-stats">
              <Card.Body>
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category">Labs Onboard</p>
                      {itemList.map(itemList => (
                      <Card.Title as="h4">{itemList.labs}</Card.Title>))} 
                    </div>
                  </Col>
                </Row>
              </Card.Body>
            ...
            <Card className="card-stats">
              <Card.Body>
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category">No. of Packages</p>
                      {itemList.map(itemList => (
                      <Card.Title as="h4">{itemList.packages}</Card.Title>))} 
                    </div>
                  </Col>
                </Row>
              </Card.Body>
            ...
            <Card>
              ...
              <Card.Footer>
                <div className="legend">
                  ...
                  Total Subscription<i className="fas fa-circle text-warning"></i>
                  Consultation
                </div>
                {/* <hr></hr>
                <div className="stats">
